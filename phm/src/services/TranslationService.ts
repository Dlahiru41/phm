...
const translations: Record<Language, Partial<TranslationKeys>> = {
  en: {
    ...
    'adminDashboard.createMoh.subtitle': 'Fill in MOH officer details to create account instantly. A secure temporary password will be generated and sent via OTP.',
    ...
    'adminDashboard.createMoh.successNote1': 'Temporary password sent via OTP',
    ...
    'addChild.confirmText': 'Is this your child? We will send a verification code to the registered mobile number.',
    'addChild.sendOtp': 'Send Verification Code',
    'addChild.otpTitle': 'Verify Identity',
    'addChild.otpText': 'A 6-digit verification code has been sent to the registered mobile number.',
    ...
    'addChild.foundText': 'Request a verification code to be sent to the parent mobile number on file.',
    ...
    'babyReg.whatsapp': 'Parent Mobile Number',
  ...
  si: {
    ...
    'addChild.confirmText': 'මෙය ඔබේ දරුවාද? ලියාපදිංචි කර ඇති අංකයට අපි සත්‍යාපන කේතයක් එවන්නෙමු.',
    'addChild.sendOtp': 'සත්‍යාපන කේතය එවන්න',
    'addChild.otpTitle': 'අනන්‍යතාවය සත්‍යාපනය කරන්න',
    'addChild.otpText': 'ලියාපදිංචි අංකයට ඉලක්කම් 6ක සත්‍යාපන කේතයක් එවා ඇත.',
    ...
    'addChild.foundText': 'ලියාපදිංචි කර ඇති අංකයට සත්‍යාපන කේතයක් එවීමට ඉල්ලන්න.',
    ...
    'babyReg.whatsapp': 'මව්පියන්ගේ අංකය',
  ...
  ta: {
    ...
    'adminDashboard.createMoh.subtitle': 'கணக்கை உடனடியாக உருவாக்க MOH அதிகாரியின் விவரங்களை நிரப்பவும். ஒரு பாதுகாப்பான தற்காலிக கடவுச்சொல் உருவாக்கப்பட்டு வழியாக அனுப்பப்படும்.',
    ...
    'adminDashboard.createMoh.successNote1': 'தற்காலிக கடவுச்சொல் வழியாக அனுப்பப்பட்டது',
